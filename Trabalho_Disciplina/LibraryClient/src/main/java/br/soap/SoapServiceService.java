 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://soap.br/", wsdlLocation = "file:/home/ticnic/wsdl/meu_servico.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://soap.br/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/ticnic/wsdl/meu_servico.wsdl");
     ...
     * 
     * @return
     *     returns ISoapServices
     */
    @WebEndpoint(name = "SoapServicePort")
    public ISoapServices getSoapServicePort() {
        return super.getPort(new QName("http://soap.br/", "SoapServicePort"), ISoapServices.class);
    }
     ...
     */
    @WebEndpoint(name = "SoapServicePort")
    public ISoapServices getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.br/", "SoapServicePort"), ISoapServices.class, features);
    }
